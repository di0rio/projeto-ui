...
import style from "./Tasters.module.css";

// import a from "../../assets/div.png"
...
const Tasters = () => {
  ...
  return (
    <div className={style.test}>
      ...
      <Box
        sx={{ marginLeft:"11em" ,display: "flex", flexWrap: "wrap", alignContent:"center", justifyContent:"center" ,minWidth: 300, width: "80%" }}
      >
        {images.map((image) => (
          <ImageButton
            focusRipple
